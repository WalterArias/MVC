                ...
                <form class="formeditar" method="POST">
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <input id="apellido" class="form-control form-control-sm" type="text" name="apellido"
                                required>
                            <label for="direccion">Dirección</label>
                            <input id="direccion" class="form-control form-control-sm" type="text" name="direccion"
                                required>
                    ...
                    <div class="card-footer">
                        <button class="btn btn-sm btn-secondary" type="button" id="imprimir" data-toggle='tooltip'
                            data-placement='top' title='Imprime'> <i class="bi bi-printer"></i></button>
                        <button class="btn btn-sm btn-secondary" type="button" id="cancelar" data-toggle='tooltip'
                            data-placement='top' title='Cancela Operacion'><i class="bi bi-x-square"></i></button>
