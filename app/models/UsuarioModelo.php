...
/* 
  ...
  public function crearcliente($datos)
    {
        $this->db->query('INSERT INTO cliente (clientenombre, clienteapellidos, direccion,email,fechaingreso,deuda,imagen, estado) VALUES (:nombre,  :apellido, :direccion,
         :email, :fecha,  :deuda, :imagen, :estado);');
